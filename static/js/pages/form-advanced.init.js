!(function (s) {
    ...
    (e.prototype.init = function () {
        ...
        s('[data-toggle="touchspin"]').each(function (e, t) {
            ...
            s("input[name='demo3_21']").TouchSpin({ initval: 40, buttondown_class: "btn btn-primary downer", buttonup_class: "btn btn-primary upper" }),
            s("input[name='demo3_22']").TouchSpin({ initval: 40, buttondown_class: "btn btn-success downer", buttonup_class: "btn btn-success upper" }),
