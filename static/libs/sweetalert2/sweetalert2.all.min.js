!(function (t, e) {
    ...
    function Pt(t, e) {
        ...
        i &&
            ...
            (o = i),
            (n = e.position) in $ ? gt(o, $[n]) : (z('The "position" parameter is not valid, defaulting to "center"'), gt(o, $.center)),
            (n = i),
    ...
    function Mt(t, e) {
        ...
        e.html ? (ft(e.html, n), it(n, "block")) : e.text ? ((n.textContent = e.text), it(n, "block")) : rt(n),
            (t = t),
            (o = e),
            (i = P()),
        ...
        r >= o.progressSteps.length && z("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),
            o.progressSteps.forEach(function (t, e) {
                ...
                i.appendChild(t),
                    ...
                    e !== o.progressSteps.length - 1 && ((t = o), (e = document.createElement("li")), gt(e, $["progress-step-line"]), t.progressStepsDistance && (e.style.width = t.progressStepsDistance), (e = e), i.appendChild(e));
            });
    }
    function Ht(t, e) {
        var n = j();
                    ...
                    : (_t(),
                      e.icon &&
                          (-1 !== Object.keys(J).indexOf(e.icon)
                              ? ((t = k(".".concat($.icon, ".").concat(J[e.icon]))), it(t), Wt(t, e), Ft(t, e), gt(t, e.showClass.icon))
                              : W('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(e.icon, '"'))));
            })(t, e),
            (function (t) {
                var e = E();
    ...
    var _t = function () {
        ...
        Qt = function (t, e) {
            (t.className = "".concat($.popup, " ").concat(bt(t) ? e.showClass.popup : "")),
                e.toast ? (gt([document.documentElement, document.body], $["toast-shown"]), gt(t, $.toast)) : gt(t, $.modal),
                F(t, e, "popup"),
    ...
    function be(t, e, n, o) {
        n
            ...
            : (Jt().then(function () {
              ...
              oe.keydownTarget.removeEventListener("keydown", oe.keydownHandler, { capture: oe.keydownListenerCapture }),
            ...
            N() &&
                ...
                _(document.body, $.iosfix) && ((e = parseInt(document.body.style.top, 10)), vt(document.body, $.iosfix), (document.body.style.top = ""), (document.body.scrollTop = -1 * e)),
    ...
    function we(t) {
        ...
        i &&
            ...
            (e = St.innerParams.get(this)) &&
                ...
                ((n = ye.swalPromiseResolve.get(this)), vt(i, e.showClass.popup), gt(i, e.hideClass.popup), (o = C()), vt(o, e.showClass.backdrop), gt(o, e.hideClass.backdrop), ke(this, i, e), n(t)));
    }
    function Ce(t) {
        return void 0 === t ? { isConfirmed: !1, isDenied: !1, isDismissed: !0 } : c({ isConfirmed: !1, isDenied: !1, isDismissed: !1 }, t);
    }
    function ke(t, e, n) {
        var o = C(),
            i = Bt && ut(e),
    ...
    var je = function (t, e) {
        ...
        Ve = function (t, e, n) {
            ...
            ((/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream) || ("MacIntel" === navigator.platform && 1 < navigator.maxTouchPoints)) &&
                ...
                ((o = document.body.scrollTop), (document.body.style.top = "".concat(-1 * o, "px")), gt(document.body, $.iosfix), me(), fe()),
    ...
    function pn(a, s, c) {
        return new Promise(function (t) {
            ...
            ye.swalPromiseResolve.set(a, t),
                ...
                (r = c),
                (i = e),
                (t = oe).keydownTarget && t.keydownHandlerAdded && (t.keydownTarget.removeEventListener("keydown", t.keydownHandler, { capture: t.keydownListenerCapture }), (t.keydownHandlerAdded = !1)),
                r.toast ||
    ...
    function fn(t) {
        var e = { popup: x(), container: C(), content: P(), actions: q(), confirmButton: T(), denyButton: L(), cancelButton: I(), loader: D(), closeButton: R(), validationMessage: S(), progressSteps: O() };
        ...
        Q = Object.freeze({
            ...
            showValidationMessage: function (t) {
                ...
                U(e.validationMessage, t),
                    ...
                    (e = this.getInput()) && (e.setAttribute("aria-invalid", !0), e.setAttribute("aria-describedBy", $["validation-message"]), et(e), gt(e, $.inputerror));
            },
            ...
            update: function (e) {
                ...
                Object.keys(e).forEach(function (t) {
                    ...
                    Object.defineProperties(this, { params: { value: c({}, this.params, e), writable: !1, enumerable: !0 } });
            },
            _destroy: function () {
                var t = St.domCache.get(this),
                    e = St.innerParams.get(this);
                e &&
                    (t.popup && oe.swalCloseEventFinishedCallback && (oe.swalCloseEventFinishedCallback(), delete oe.swalCloseEventFinishedCallback),
                    oe.deferDisposalTimer && (clearTimeout(oe.deferDisposalTimer), delete oe.deferDisposalTimer),
                    yn(e),
                    bn(this));
            },
        }),
